...
class CertificateController extends Controller
{
    ...
    public function setForCreate(Request $request, $course_uuid)
    {
        ...
        {
            $this->showToastrMessage('warning', 'Please select certificate');
    ...
    public function edit($uuid)
    {
        ...
        $data['certificate_by_instructor'] = Certificate_by_instructor::whereUuid($uuid)->first();
        return view('instructor.certificate.edit', $data);
    }

    public function update(Request $request, $uuid)
    {
        $certificate_by_instructor = Certificate_by_instructor::whereUuid($uuid)->first();
