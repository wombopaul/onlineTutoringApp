...
class AssignmentController extends Controller
{
    ...
    public function store(Request $request, $course_uuid)
    {
        ...
        $this->showToastrMessage('success', 'Assignment Created Successfully');
    ...
    public function update(Request $request, $course_uuid, $uuid)
    {
        ...
        $this->showToastrMessage('success', 'Assignment Updated Successfully');
        return redirect()->route('assignment.index', $course_uuid);
    }
    ...
    public function delete($uuid)
    {
        ...
        $this->showToastrMessage('success', 'Assignment Deleted Successfully');
    ...
    public function assessmentSubmitMarkUpdate(Request $request, $assignment_submit_uuid)
    {
        ...
        $this->showToastrMessage('success', 'Marks Updated Successfully');
        return redirect()->back();
    }
