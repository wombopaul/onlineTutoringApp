...
class PageController extends Controller
{
    ...
    public function edit($uuid)
    {
        ...
        $this->showToastrMessage('error', 'Page not found!');
    ...
    public function update(Request $request, $uuid)
    {
        ...
        if($page) {
            ...
            if(!empty($update)) {
                $this->showToastrMessage('success', 'Page successfully updated');
                return redirect()->route('page.index');
            }
        }
    ...
    public function delete($uuid)
    {
        ...
        if(!empty($page)) {
            $this->showToastrMessage('success', 'Page successfully deleted');
            return redirect()->back();
        }
