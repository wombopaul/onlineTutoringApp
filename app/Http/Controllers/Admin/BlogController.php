...
class BlogController extends Controller
{
    ...
    public function store(BlogRequest $request)
    {
        ...
        $data = [
            ...
            'image' => $request->image ? $this->saveImage('blog', $request->image, null, 500) :   null,
        ];
    ...
    public function update(BlogRequest $request, $uuid)
    {
        ...
        if ($request->image)
        {
            ...
            $image = $this->saveImage('blog', $request->image, null, 500); // new file upload into server
    ...
    public function delete($uuid)
    {
        ...
        $this->showToastrMessage('error', 'Blog has been deleted');
