...
class CouponController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['coupons'] = $this->couponModel->all();
    ...
    public function store(CouponRequest $request)
    {
        ...
        $this->showToastrMessage('success', 'Coupon Created Successfully');
    ...
    public function update(Request $request, $uuid)
    {
        ...
        $this->showToastrMessage('success', 'Coupon Updated Successfully');
        return redirect()->route('coupon.index');
    ...
    public function delete($uuid)
    {
        ...
        $this->showToastrMessage('success', 'Coupon Delete Successfully');
