...
class PromotionController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['promotions'] =  $this->promotionModel->all();
    ...
    public function store(PromotionRequest $request)
    {
        ...
        $this->showToastrMessage('success', 'Promotion created successfully');
    ...
    public function update(PromotionRequest $request, $uuid)
    {
        ...
        $this->showToastrMessage('success', 'Promotion updated successfully');
        return redirect()->route('promotion.index');
    }
    ...
    public function delete($uuid)
    {
        ...
        $this->showToastrMessage('success', 'Promotion deleted successfully');
