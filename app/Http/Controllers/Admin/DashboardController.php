...
class DashboardController extends Controller
{
    public function dashboard()
    {
        ...
        Order::where('payment_status', 'paid')->orWhere('payment_status', 'free')->select(DB::raw('COUNT(id) as total'), DB::raw('MONTHNAME(created_at) month'))
            ->groupby('month')
            ->get()
        ...
        Order::where('payment_status', 'paid')->orWhere('payment_status', 'free')->select(DB::raw('COUNT(id) as total'), DB::raw('YEAR(created_at) year'))
            ->groupby('year')
            ->get()
        ...
        $total_order_item = Order_item::whereHas('order', function ($q) {
