...
Route::prefix('report')->group(function () {
    Route::get('revenue-report', [ReportController::class, 'revenueReportIndex'])->name('report.revenue-report');
...
Route::group(['prefix' => 'special-promotional-tag', 'as' => 'special_promotional_tag.'], function (){
    ...
    Route::get('edit-special-pomotion-course/{uuid}', [SpecialPromotionTagController::class, 'editSpecialPromotionCourse'])->name('editSpecialPromotionCourse');
...
Route::group(['prefix' => 'settings', 'as' => 'settings.'], function () {
    ...
    //Start:: Zoom Settings
    Route::get('zoom-settings', [SettingController::class, 'ZoomSettings'])->name('zoom-settings');
    Route::post('zoom-settings-update', [SettingController::class, 'ZoomSettingsUpdate'])->name('zoom-settings.update');
    ...
    Route::post('aws-settings-update', [SettingController::class, 'awsSettingsUpdate'])->name('aws-settings.update');
    ...
    Route::post('special-feature-section-settings', [HomeSettingController::class, 'specialFeatureSectionUpdate'])->name('special-feature-section.update');
