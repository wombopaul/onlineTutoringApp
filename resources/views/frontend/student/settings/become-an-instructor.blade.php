    ...
    <div class="bg-page">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="page-banner-content text-center">
                                <h3 class="page-banner-heading text-white pb-15">{{__('app.become_an_instructor')}}</h3>

                                <!-- Breadcrumb Start-->
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item font-14"><a href="{{ url('/') }}">{{__('app.home')}}</a></li>
                                        <li class="breadcrumb-item font-14 active" aria-current="page">{{__('app.become_an_instructor')}}</li>
                                    </ol>
                                </nav>
                                <!-- Breadcrumb End-->
                            </div>
            ...
            <div class="container">
                    ...
                    @foreach($instructorFeatures as $instructorFeature)
                        ...
                        <div class="col-md-4">
                            <div class="become-instructor-feature-item bg-white theme-border">
                                ...
                                <h6>{{ $instructorFeature->title }}</h6>
                                <p>{{ $instructorFeature->subtitle }}</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="d-flex justify-content-sm-center become-instructor-call-to-action align-items-center mt-50">
                        <button class="theme-btn theme-button1 theme-button3 mr-30" data-bs-toggle="modal" data-bs-target="#becomeAnInstructor"> {{__('app.become_an_instructor')}} <i data-feather="arrow-right"></i></button>
                        <a href="{{route('contact')}}" class="text-decoration-underline font-15 font-medium"> {{__('app.contact_with_us')}}</a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="col-md-6">
                            <div class="become-an-instructor-procedure-item-right">
                                <div class="section-title">
                                    <h3 class="section-heading">{{ $instructorProcedure->title }}</h3>
                                </div>
                                <p class="mb-15">{{ $instructorProcedure->subtitle }}</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="counter-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 counter-content">
                                <h4 class="text-uppercase count-content"><span class="counter">{{ @$total_students }}</span>+</h4>
                                <p class="text-uppercase font-14 font-medium color-gray mt-2">Students</p>
                            </div>
                        </div>
                    </div>
                    <!-- Counter Item End-->
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="counter-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 counter-content">
                                <h4 class="text-uppercase count-content"><span class="counter">{{ @$total_enrollments }}</span></h4>
                                <p class="text-uppercase font-14 font-medium color-gray mt-2">Enrollments</p>
                            </div>
                        </div>
                    </div>
                    <!-- Counter Item End-->
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="counter-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 counter-content">
                                <h4 class="text-uppercase count-content"><span class="counter">{{ @$total_instructors }}</span>+</h4>
                                <p class="text-uppercase font-14 font-medium color-gray mt-2">Instructor</p>
                            </div>
                        </div>
                    </div>
                    <!-- Counter Item End-->
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="counter-item d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 counter-content">
                                <h4 class="text-uppercase count-content"><span class="counter">100</span>%</h4>
                                <p class="text-uppercase font-14 font-medium color-gray mt-2">Satisfaction</p>
                            </div>
                        </div>
                    </div>
                    <!-- Counter Item End-->
        ...
        <section class="become-instructor-call-to-action section-t-space text-center">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="section-heading">{{ get_option('app_instructor_footer_title') }}</h3>
                        <div class="col-lg-6 mx-auto">
                            <p class="font-20 mb-4">{{ get_option('app_instructor_footer_subtitle') }}</p>
                            <div class="d-flex justify-content-center align-items-center">
                                <button class="theme-btn theme-button1 theme-button3 mr-30" data-bs-toggle="modal" data-bs-target="#becomeAnInstructor"> {{__('app.become_an_instructor')}} <i data-feather="arrow-right"></i></button>
                                <a href="{{route('contact')}}" target="_blank" class="text-decoration-underline font-15 font-medium">{{__('app.contact_with_us')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="{{route('student.save-instructor-info')}}" class="needs-validation" novalidate enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('app.first_name')}}</label>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('app.last_name')}}</label>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label for="professional_title" class="label-text-title color-heading font-medium font-16 mb-2">{{__('app.professional_title')}}</label>
                                <input type="text" name="professional_title" class="form-control" id="professional_title" placeholder="{{__('app.professional_title')}}" value="{{ old('professional_title') }}">
                            </div>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('app.phone_number')}}</label>
                                <input type="text" name="phone_number" class="form-control" id="phone_number" placeholder="{{__('app.phone_number')}}" value="{{ @Auth::user()->student->phone_number }}" required>
                            </div>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('app.address')}}</label>
                                <input type="text" name="address" class="form-control" id="address" placeholder="{{__('app.address')}}" value="{{ @Auth::user()->student->address }}" required>
                            </div>
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <label class="label-text-title color-heading font-medium font-16 mb-2">{{__('app.bio')}}</label>
