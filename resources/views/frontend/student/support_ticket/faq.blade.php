                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12">
                            <div class="page-banner-content text-center">
                                <h3 class="page-banner-heading text-white pb-15">Support Ticket</h3>

                                <!-- Breadcrumb Start-->
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item font-14"><a href="{{ url('/') }}">Home</a></li>
                                        <li class="breadcrumb-item font-14 active" aria-current="page">Support Ticket</li>
                                    </ol>
                                </nav>
                                <!-- Breadcrumb End-->
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="section-title text-center">
                        <h3 class="section-heading">{{ get_option('support_faq_title') }}</h3>
                        <p class="section-sub-heading">{{ get_option('support_faq_subtitle') }}</p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="is-that-helpful-content text-center mt-30 pt-4">
                            <h5 class="mb-3">{{ get_option('ticket_title') }}</h5>
                            <h4 class="mb-3">{{ get_option('ticket_subtitle') }}</h4>
                            <div class="is-that-helpful-btns">
                                <a href="{{ route('student.support-ticket.create') }}" class="theme-btn theme-button1 default-hover-btn ">Create New Ticket</a>
                                <a href="{{ route('student.support-ticket.create') }}" class="theme-btn theme-button1 default-hover-btn green-theme-btn">View Ticket</a>
                            </div>
                        </div>
                    </div>
                </div>
