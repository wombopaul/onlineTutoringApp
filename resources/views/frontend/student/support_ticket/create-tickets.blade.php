                        ...
                        <div class="page-banner-content text-center">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    ...
                                    <li class="breadcrumb-item font-14"><a href="{{ route('support-ticket-faq') }}">Support Tickets</a></li>
                                    <li class="breadcrumb-item font-14 active" aria-current="page">Create new Ticket</li>
                                </ol>
                            </nav>
                            <!-- Breadcrumb End-->
                        </div>
                        ...
                        <ul class="nav nav-tabs assignment-nav-tabs live-class-list-nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="create_new_ticket-tab" data-bs-toggle="tab" data-bs-target="#create_new_ticket" type="button" role="tab"
                                        aria-controls="create_new_ticket" aria-selected="true">Create New Ticket
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="view_ticket-tab" data-bs-toggle="tab" data-bs-target="#view_ticket" type="button" role="tab"
                                        aria-controls="view_ticket" aria-selected="false">View Ticket
                                </button>
                            </li>
                        </ul>
                                ...
                                <form action="{{ route('student.support-ticket.store') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-30">
                                            <div class="label-text-title color-heading font-medium font-16 mb-3">Name
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-30">
                                            <div class="label-text-title color-heading font-medium font-16 mb-3">Email Address
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-30">
                                            <div class="label-text-title color-heading font-medium font-16 mb-3">Subject
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-30">
                                            <label class="label-text-title color-heading font-medium font-16 mb-3">Department
                                            </label>
                                        ...
                                        <div class="col-md-4 mb-30">
                                            <label class="label-text-title color-heading font-medium font-16 mb-3">Related Service
                                            </label>
                                        ...
                                        <div class="col-md-4 mb-30">
                                            <label class="label-text-title color-heading font-medium font-16 mb-3">Priority
                                            </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-30">
                                            <div class="label-text-title color-heading font-medium font-16 mb-3">Message
                                            </div>
