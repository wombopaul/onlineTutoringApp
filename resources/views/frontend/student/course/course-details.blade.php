                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12">
                                <div class="page-banner-content text-center">
                                    <h3 class="page-banner-heading color-heading pb-15">{{ $course->title }}</h3>
                    ...
                    <div class="col-12 col-md-12 col-lg-12 col-xl-7 col-xxl-8">
                        @if(@$lecture_type)
                            ...
                            <div class="video-player-area">
                                @if(@$lecture_type == 'youtube')
                                    <!--Youtube Video Frame -->
                                    <div class="youtubePlayer" id="myYoutubeVideo">
                                        <iframe class="xdPlayer"  src="https://www.youtube.com/embed/{{ @$youtube_video_src }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                    </div>
                                    <!--Youtube Video Frame -->
                                @elseif(@$lecture_type == 'vimeo')
                                    <!--Vimeo Video Frame -->
                                    <div class="vimeoPlayer" id="vimeoPlayer">
                                        <iframe  class="xdPlayer" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" allow="autoplay" frameborder="0"
                                                src="https://player.vimeo.com/video/{{ @$vimeo_video_src }}?rel=0&amp;autoplay=1"></iframe>
                                    </div>
                                    <!--Vimeo Video Frame -->
                                @elseif(@$lecture_type == 'video')
                                    <!--Video/mp4 Video Frame -->
                                    <video class="videoPlayer " id="myVideo" controls controlsList="nodownload">
                        ...
                        @else
                            ...
                            <video class="videoPlayer " controls controlsList="nodownload">
                                <source class="xdPlayer lectureVideo" src="{{ getVideoFile(@$course->video) }}" type="video/mp4">
                            </video>
                            <!--Video/mp4 Video Frame -->
                        @endif
                                    ...
                                    <div class="barras mb-4">
                                        <div class="progress-bar-box">
                                            <div class="progress-hint-value font-14 color-heading d-flex justify-content-between">
                                                <p class="font-20 font-medium color-heading">Course content</p>
                                        ...
                                        @forelse(@$course->lessons as $key => $lesson)
                                            <div class="accordion-item">
                                                <h2 class="accordion-header" id="heading{{ $key }}">
                                                    <button class="accordion-button font-medium font-18 d-flex justify-content-between {{ @$lesson_id_check == $lesson->id ?  '' : 'collapsed' }}" type="button"
                                                            data-bs-toggle="collapse"
                                                            data-bs-target="#collapse{{ $key }}" aria-expanded="{{ @$lesson_id_check == $lesson->id ?  true : false }}" aria-controls="collapse{{ $key }}">
                                                ...
                                                <div id="collapse{{ $key }}" class="accordion-collapse collapse {{ @$lesson_id_check == $lesson->id ?  'show' : '' }}" aria-labelledby="heading{{ $key }}"
                                                    ...
                                                    <div class="accordion-body">
                                                        <div class="play-list">
                                                            ...
                                                            @forelse($lesson->lectures as  $lecture)
                                                                ...
                                                                <div class="play-list-item @if(checkStudentCourseView($course->id, $lecture->id)) watchFinishedCourse @elseif($lecture->id == @$lecture_id_check) watchContinuingCourse @endif d-flex align-items-center justify-content-between font-15">
                                                                    <div class="play-list-left d-flex align-items-center">
                                                                        <div>
                                                                            ...
                                                                            @elseif(checkStudentCourseView($course->id, $lecture->id))
                                                                        ...
                                                                        <a href="{{ route('student.my-course.show', [Str::slug($course->slug), 'lecture_uuid' => $lecture->uuid]) }}"><p class="ps-2">{{ $lecture->title }}</p></a>
                                                                    </div>
                            ...
                            <div class="course-tab-nav-wrap course-details-tab-nav-wrap d-flex justify-content-between">
                                <ul class="nav nav-tabs tab-nav-list border-0" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-uppercase {{!$action_type ? 'active' : '' }}" id="Overview-tab" data-bs-toggle="tab" href="#Overview" role="tab"
                                           aria-controls="Overview"
                                           aria-selected="true">Overview</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-uppercase" id="Resources-tab" data-bs-toggle="tab" href="#Resources" role="tab" aria-controls="Resources"
                                           aria-selected="true">Resources</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-uppercase" id="Review-tab" data-bs-toggle="tab" href="#Review" role="tab" aria-controls="Review"
                                           aria-selected="false">Review</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-uppercase {{$action_type ? 'active' : '' }}" id="Quiz-tab" data-bs-toggle="tab" href="#Quiz" role="tab"
                                           aria-controls="Quiz" aria-selected="false">Quiz</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-uppercase" id="Assignment-tab" data-bs-toggle="tab" href="#Assignment" role="tab" aria-controls="Quiz"
                                           aria-selected="false">Assignment</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-uppercase" id="Notice-tab" data-bs-toggle="tab" href="#Notice" role="tab" aria-controls="Notice"
                                           aria-selected="false">Notice</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-uppercase" id="LiveClass-tab" data-bs-toggle="tab" href="#LiveClass" role="tab" aria-controls="LiveClass"
                                           aria-selected="false">Live Class</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-uppercase" id="Discussion-tab" data-bs-toggle="tab" href="#Discussion" role="tab" aria-controls="Discussion"
                                           aria-selected="false">Discussion</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-uppercase" id="Certificate-tab" data-bs-toggle="tab" href="#Certificate" role="tab" aria-controls="Certificate"
