            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-7">
                <div class="course-watch-assignment-content-left">
                    ...
                    <div class="course-watch-assignment-text mb-4">
                        <p class="font-18 color-heading font-medium mb-3">Assignment Topic</p>
                        <p class="color-gray">{{ @$assignment->name }}</p>
                    </div>

                    <div class="course-watch-assignment-text mb-4">
                        <p class="font-18 color-heading font-medium mb-3">Assignment Description</p>
            ...
            <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-5">
                <div class="course-watch-assignment-content-right mb-30">
                    <div class="course-watch-assignment-top-text">
                        <div class="row">
                            <div class="col-6">
                                <h6 class="font-20 font-medium">Marks</h6>
                                <p class="color-gray">{{ @$assignment->marks }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="course-watch-assignment-files">
                        <h6 class="font-20 font-medium">Assignment File</h6>
                        <div class="resource-list-text">
                            <span class="iconify" data-icon="akar-icons:link-chain"></span>
                            <a href="{{ getImageFile(@$assignment->file) }}" class="text-decoration-underline font-medium">{{ @$assignment->original_filename }}</a> {{ @$assignment->size }}
                        </div>

                    </div>

                    <div class="course-watch-assignment-files">
                        <h6 class="font-20 font-medium">Your Submit File</h6>
                        <div class="resource-list-text">
                            <span class="iconify" data-icon="akar-icons:link-chain"></span>
                            <a href="{{ getImageFile(@$assignmentSubmit->file) }}" class="text-decoration-underline font-medium">{{ @$assignmentSubmit->original_filename }}</a> {{ @$assignmentSubmit->size }}
                        </div>

                    </div>
                </div>
                <div class="col-12">
                    <button class="theme-btn default-back-btn default-hover-btn viewAssignmentList">Back</button>
