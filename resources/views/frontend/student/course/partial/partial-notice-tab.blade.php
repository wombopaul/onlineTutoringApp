                    ...
                    <div class="row">
                                ...
                                <div class="col-lg-12 col-xl-12 col-xxl-6">
                                    <div class="notice-board-box-item">
                                        ...
                                        <div class="notice-board-box">
                                            <div class="notice-board-pin-img text-center"><img src="{{ asset('frontend/assets/img/notice-board-pin.png') }}" alt="img"
                                                                                               class="img-fluid"></div>
                        ...
                        @else
                            ...
                            <div class="empty-data">
                                <img src="{{ asset('frontend/assets/img/empty-data-img.png') }}" alt="img" class="img-fluid">
                                <h5 class="my-3">Empty Notice Board</h5>
                            </div>
                            <!-- If there is no data Show Empty Design End -->
                        @endif
                    </div>
