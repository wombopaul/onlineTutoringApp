        ...
        <div class="accordion" id="accordionPanelsStayOpenExample">
                                ...
                                <div class="accordion-item sidebar-inner-accordion-item">
                                    ...
                                    <div id="innercollapse{{ $key }}" class="accordion-collapse collapse" aria-labelledby="innerheading{{ $key }}" data-bs-parent="#accordionExample2">
                                        <div class="accordion-body inner-accordion-body">
                                            ...
                                            @empty
                                                <div class="row">
                                                    <small>{{ __('app.no_sub_category_found') }}!</small>
                                                </div>
                                            @endforelse
                        ...
                        <div class="sidebar-radio-item">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="exampleRadios42">
                                    <span class="iconify" data-icon="bi:star-fill"></span>4 star or above
                                </label>
                            </div>
                            <div class="radio-right-text"></div>
                        </div>
                        ...
                        <div class="sidebar-radio-item">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="exampleRadios43">
                                    <span class="iconify" data-icon="bi:star-fill"></span>3 star or above
                                </label>
                            </div>
                            <div class="radio-right-text"></div>
                        </div>
                        ...
                        <div class="sidebar-radio-item">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="exampleRadios44">
                                    <span class="iconify" data-icon="bi:star-fill"></span>2 star or above
                                </label>
                            </div>
                            <div class="radio-right-text"></div>
                        </div>
                        ...
                        <div class="sidebar-radio-item">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="exampleRadios45">
                                    <span class="iconify" data-icon="bi:star-fill"></span>1 star or above
                                </label>
                            </div>
                            <div class="radio-right-text"></div>
                        </div>
            ...
            <div class="accordion-item course-sidebar-accordion-item">
                ...
                <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingFour">
                    <div class="accordion-body">
                        <div id="slider-range" class="price-filter-range filterPriceRange"></div>

                        <div class="range-value-box">
                            <div class="range-value-wrap"><label for="min_price">{{ get_option('app_currency') }}Min:</label>
                                <input disabled type="number" min=0 max="9900" id="min_price" class="price-range-field min_price" />
                            </div>
                            <div class="range-value-wrap"><label for="max_price">{{ get_option('app_currency') }}Max:</label>
                                <input disabled type="number" min=0 max="10000" id="max_price" class="price-range-field max_price" />
                            </div>
                        </div>
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="sidebar-radio-item">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="exampleRadiosDuration34">{{ __('app.Less_than_24_hours') }}</label>
                            </div>
                        </div>
                        <div class="sidebar-radio-item">
                            <div class="form-check">
                                <input class="form-check-input filterDuration" type="checkbox" name="filterDuration" id="exampleRadiosDuration35" value="2">
                                <label class="form-check-label" for="exampleRadiosDuration35">{{ __('app.24_to_36_hours') }}</label>
                            </div>
                        </div>
                        ...
                        <div class="sidebar-radio-item">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="exampleRadiosDuration36">{{ __('app.36_to_72_hours') }}</label>
                            </div>
                        </div>
                        <div class="sidebar-radio-item">
                            <div class="form-check">
                                <input class="form-check-input filterDuration" type="checkbox" name="filterDuration" id="exampleRadiosDuration37" value="4">
                                <label class="form-check-label" for="exampleRadiosDuration37">{{ __('app.above_72_hours') }}</label>
                            </div>
                        </div>
...
<!-- Price range for filter.js -->
<input type="hidden" class="highest_price" value="{{ $highest_price }}">
