    ...
    <div class="row">
                                ...
                                <div class="comment-content-part-top">
                                    <h6 class="font-18 mb-15 text-capitalize">{{@$discussion->user->name}}
                                        @if($discussion->comment_as == 1)
                                            <span class="teacher-badge bg-light-purple color-hover font-14 font-medium radius-4 px-2 py-1">{{ __('app.instructor') }}</span>
                                        @endif
                                    </h6>
                                    <p class="font-15">
        ...
        @else
            <div class="no-course-found text-center">
                ...
                <h5 class="mt-3">{{ __('app.no_discussion_found') }}</h5>
            </div>
        @endif
    </div>
</div>
