            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="page-banner-content text-center">
                        <h3 class="page-banner-heading text-white pb-15">{{ __('app.about_us') }}</h3>

                        <!-- Breadcrumb Start-->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item font-14"><a href="{{ url('/') }}">{{__('app.home')}}</a></li>
                                <li class="breadcrumb-item font-14 active" aria-current="page">{{ __('app.about_us') }}</li>
                            </ol>
                        </nav>
                        <!-- Breadcrumb End-->
                    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title text-center">
                    <h3 class="section-heading">{{ @$aboutUsGeneral->gallery_area_title }}</h3>
                    <p class="section-sub-heading">{{ @$aboutUsGeneral->gallery_area_subtitle }}</p>
                </div>
            </div>
        </div>
...
<section class="our-history-area bg-page section-t-space">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="section-title text-center">
                    <h3 class="section-heading">{{ @$aboutUsGeneral->our_history_title }}</h3>
                    <p class="section-sub-heading">{{ @$aboutUsGeneral->our_history_subtitle }}</p>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-5 col-xl-6">
                <div class="upgrade-skills-right">
                    <div class="section-title">
                        <h3 class="section-heading">{{ @$aboutUsGeneral->upgrade_skill_title }}</h3>
                    </div>
                    <p>{{ @$aboutUsGeneral->upgrade_skill_subtitle }} </p>

                    <!-- section button start-->
                    <div class="col-12 section-btn">
                        <a href="{{ route('courses') }}" class="theme-btn default-hover-btn theme-button1">{{ @$aboutUsGeneral->upgrade_skill_button_name }} <i data-feather="arrow-right"></i></a>
                    </div>
                    <!-- section button end-->
                </div>
            </div>
            ...
            <div class="col-12">
                ...
                <div class="section-left-title-with-btn d-flex justify-content-between align-items-end">
                    <div class="section-title section-title-left d-flex align-items-start">
                        ...
                        <div>
                            <h3 class="section-heading">{{ @$aboutUsGeneral->team_member_title }}</h3>
                            <p class="section-sub-heading">{{ @$aboutUsGeneral->team_member_subtitle }}</p>
                        </div>
                    </div>
                </div>
                <!-- section-left-align-->
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="card instructor-item border-0">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text instructor-designation font-medium text-uppercase">{{ $teamMember->designation }}</p>
                    </div>
                </div>
            </div>
