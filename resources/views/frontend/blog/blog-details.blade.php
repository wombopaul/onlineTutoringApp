                        ...
                        <div class="blog-page-left-content">
                            ...
                            <div class="blog-item mb-0">
                                ...
                                <div class="blog-item-img-wrap overflow-hidden position-relative">
                                    ...
                                    <div
                                        class="blog-item-tag position-absolute text-uppercase font-12 font-semi-bold text-white bg-hover radius-3">{{ @$blog->category->name }}</div>
                                </div>

                                <div class="blog-item-bottom-part blog-details-content-wrap">
                                    <h3 class="card-title blog-title">{{ $blog->title }}</h3>
                                    ...
                                    <p class="card-text blog-content">{!! clean($blog->details) !!}</p>
                            ...
                            <div class="block-2">
                                <div class="share-article d-flex align-items-center">
                                    <div class="share-box color-gray font-12 text-uppercase me-4 font-medium">Share:</div>
                            ...
                            <div class="leave-comment-area bg-white">
                                <h2 class="blog-comment-title">{{ __('app.leave_a_comment') }}</h2>

                                <form action="#">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group para-color font-14 color-gray mb-30">
                                                <input type="text" class="form-control name" required placeholder="Your Name *" value="{{ @Auth::user()->name }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group para-color font-14 color-gray mb-30">
                                                <input type="email" class="form-control email" id="cus_email" required placeholder="Your Email *" value="{{ @Auth::user()->email }}"
                                                       readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group para-color font-14 color-gray nessage-text mb-30">
                                                <textarea name="message" rows="3" class="form-control comment" id="cus_comment" required placeholder="Your Comments *"></textarea>
                                            </div>
                                            <div class="contact-sub-btn">
                                                <button type="button" class="theme-button theme-button1 theme-button3 text-uppercase submitComment">{{ __('app.submit_now') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="writeReviewModalLabel">{{ __('app.comment_reply') }}</h6>
                ...
                <form action="{{ route('blog-comment-reply.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group para-color font-14 color-gray nessage-text mb-30">
                                    <textarea name="comment" rows="3" class="form-control" id="cus_comment" required placeholder="Your Comments *"></textarea>
                                </div>
                            </div>
                        </div>
                        <!-- Leave a Comment Area-->
                    ...
                    <div class="modal-footer d-flex justify-content-between align-items-center">
                        <button type="button" class="theme-btn theme-button3 modal-back-btn" data-bs-dismiss="modal">{{ __('app.cancel') }}</button>
                        <button type="submit" class="theme-btn theme-button1 default-hover-btn">{{ __('app.submit_review') }}</button>
                    </div>
                </form>
            </div>
        </div>
