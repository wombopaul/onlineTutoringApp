            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="page-banner-content text-center">
                        <h3 class="page-banner-heading text-white pb-15">{{ __('app.contact_us') }}</h3>

                        <!-- Breadcrumb Start-->
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item font-14"><a href="{{ url('/') }}">{{__('app.home')}}</a></li>
                                <li class="breadcrumb-item font-14 active" aria-current="page">{{ __('app.contact_us') }}</li>
                            </ol>
                        </nav>
                        <!-- Breadcrumb End-->
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-5 bg-white contact-page-left-side">
                ...
                <div class="contact-page-left-side-wrap">
                    <h5 class="contact-form-title font-24 font-semi-bold">{{ get_option('get_in_touch_title') }}</h5>
                    ...
                    <div class="contact-info-item d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3 contact-info-content">
                            <p>{{ get_option('contact_us_location') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="contact-info-item d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3 contact-info-content">
                            <p>{{ get_option('contact_us_email_one') }}</p>
                            <p>{{ get_option('contact_us_email_two') }}</p>
                        </div>
                    </div>
                    <!-- Contact Info Item End-->
                    ...
                    <div class="contact-info-item d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3 contact-info-content">
                            <p>{{ get_option('contact_us_phone_one') }}</p>
                            <p>{{ get_option('contact_us_phone_two') }}</p>
                        </div>
                    </div>
                    <!-- Contact Info Item End-->

                    <div class="contact-bottom-content">
                        <p class="color-gray mt-3">{{ get_option('contact_us_description') }}</p>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-7 bg-white contact-page-right">
                <div class="contact-form-area">
                    <h5 class="contact-form-title font-24 font-semi-bold">{{ get_option('send_us_msg_title') }}</h5>
                    <form>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-30">
                                <select id="inputState" class="form-select contact_us_issue_id">
                                    <option value="">{{__('app.select_an_issue')}}</option>
                        ...
                        <div class="col-12">
                            <button type="button" class="theme-btn theme-button1 theme-button3 w-100 font-15 fw-bold text-uppercase submitContactUs">{{__('app.submit')}}</button>
                        </div>
                    </form>
                </div>
            </div>
