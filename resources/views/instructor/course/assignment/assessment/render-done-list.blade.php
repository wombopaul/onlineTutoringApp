                ...
                <form>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="assignment-btn-group d-flex mt-20 mb-2">
                            ...
                            <input type="text" readonly value="{{ @$assignmentSubmitDone->marks}}" placeholder="Marks">
                        </div>
                        <div class="col-md-12">
                        ...
                        <button type="button" class="theme-btn assignment-edit-btn updateMark"
                                ...
                                data-item="{{ $assignmentSubmitDone }}" data-bs-toggle="modal" data-bs-target="#assignmentEditModal">Edit
                        </button>
                    </div>
                </form>
            </div>
