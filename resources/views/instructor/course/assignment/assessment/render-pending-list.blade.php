<div class="row">
            ...
            <div class="card assignment-assessment-item">
                <form action="{{ route('assignment.assessment.update', $assignmentSubmitPending->uuid) }}" method="post">
                    ...
                    <div class="card-body p-0">
                        ...
                        <p class="card-text">Email : {{ @$assignmentSubmitPending->user->email }}</p>
                        <div class="assignment-btn-group d-flex mt-20 mb-2">
                            <a href="{{ getImageFile($assignmentSubmitPending->file) }}" class="theme-btn bg-green text-white mb-2 downloadAssignment" data-id="{{ $assignmentSubmitPending->id }}">
                                <span class="iconify" data-icon="akar-icons:download"></span>Download
                            </a>
                            <input name="marks" class="mb-2" type="number" min="0" step="any" placeholder="Marks" required
                                   value="{{ $assignmentSubmitPending->marks }}">
                        </div>
                        <div class="col-md-12">
                            <label class="label-text-title color-heading font-medium font-16 mb-1">Notes</label>
                            <textarea name="notes" class="form-control" cols="30" rows="10"
                                      placeholder="Write your note here">{{ $assignmentSubmitPending->notes }}</textarea>
                        </div>
    ...
    @empty
        ...
        <div class="empty-data">
            ...
            <h5 class="my-3">Empty Assignment Assessment</h5>
        </div>
