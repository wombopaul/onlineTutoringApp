    ...
    <div class="page-banner-content text-center">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item font-14"><a href="{{route('resource.index', [$course->uuid])}}">Resource List</a></li>
                <li class="breadcrumb-item font-14 active" aria-current="page">Add Resources</li>
            </ol>
        </nav>
    </div>
@endsection
            ...
            <div class="row">
                <div class="col-12">
                    <form class="create-new-quiz-form" action="{{ route('resource.store', $course->uuid) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-30">
                            <div class="col-md-12">
                                <div class="create-assignment-upload-files">
                                    ...
                                    <p class="font-14 color-heading text-center mt-2 color-gray">Accepted files: ZIP</p>
                                </div>
                            </div>
                            @if ($errors->has('file'))
                        ...
                        <div>
                            <button type="submit" class="theme-btn theme-button1">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
