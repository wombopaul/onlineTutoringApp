    ...
    <div class="page-banner-content text-center">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item font-14 active" aria-current="page">True False</li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <div class="instructor-profile-right-part">
        <div class="instructor-add-question-page instructor-add-true-false-question bg-white">
            <div class="instructor-my-courses-title d-flex justify-content-between align-items-center">
                ...
                <a href="javascript:void (0);" data-bs-toggle="modal" data-bs-target="#bulkUpload"  class="theme-btn theme-button1 add-question-form-btn">Bulk Upload</a>
            </div>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="create-assignment-upload-files">
                                    ...
                                    <p class="font-14 color-heading text-center mt-2 color-gray"><a href="{{url('bulk_upload/true-false-question.csv')}}" download=""> <i class="fa fa-download"></i> View Sample File</a> </p>
                                </div>
                            </div>
                        </div>
                    </div>
