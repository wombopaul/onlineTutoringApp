...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-white pb-15"> {{__('app.manage_question')}} </h3>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item font-14 active" aria-current="page">Edit MCQ Quiz</li>
            </ol>
        </nav>
    </div>
@endsection
                    ...
                    <div class="upload-course-item-block radius-8">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-30">
                                <label class="label-text-title color-heading font-medium font-16 mb-3">Question  </label>
                                <input type="text" name="name" value="{{$question->name}}" required class="form-control" placeholder="Enter your question">
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-30">
                                            <div class="openion-item d-flex align-items-center">
                                                <input type="text" name="options[]" value="{{$option->name}}" required class="form-control" placeholder="{{__('app.option')}} {{$key + 1}}">
                        ...
                        <div class="question-openion-btn-wrap d-flex justify-content-between align-items-start mb-20">
                            ...
                            <div class="add-question-save-btns">
                                ...
                                <a href="{{route('exam.view', [$exam->uuid])}}" class="theme-btn theme-button3 show-last-phase-back-btn">{{__('app.cancel')}}</a>
