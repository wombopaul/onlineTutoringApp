    ...
    <div class="page-banner-content text-center">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item font-14 active" aria-current="page">Update Quiz</li>
            </ol>
        </nav>
    </div>
@endsection
                    ...
                    <form method="POST" action="{{route('exam.update', [$exam->uuid])}}" class="create-new-quiz-form needs-validation" novalidate>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-30">
                                ...
                                <input type="text" name="name" value="{{$exam->name}}" class="form-control" placeholder="Enter your quiz name" required>
                                @if ($errors->has('name'))
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-30">
                                ...
                                <select name="type" id="type" class="form-select" required>
                                    <option value="multiple_choice" {{$exam->type == 'multiple_choice' ? 'selected' : '' }} >Multiple Choice</option>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-30">
                                ...
                                <input type="number" min="1" name="marks_per_question" value="{{$exam->marks_per_question}}" class="form-control" placeholder="Enter your marks per question" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-30">
                                ...
                                <input type="number" min="1" class="form-control" name="duration" value="{{$exam->duration}}" placeholder="Enter your time duration" required>
                            </div>
                        </div>

                        <div>
                            <a href="{{route('exam.index', @$exam->course->uuid)}}" class="theme-btn theme-button3 quiz-back-btn">{{__('app.back')}}</a>
                            <button type="submit" class="theme-btn theme-button1">{{__('app.save')}}</button>
                        </div>
