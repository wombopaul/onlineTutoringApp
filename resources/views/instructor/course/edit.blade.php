                                ...
                                <div id="upload-course-overview-1">
                                    <form method="POST" action="{{route('course.update.overview', [$course->uuid])}}" id="step1" class="row g-3 needs-validation" novalidate>
                                        ...
                                        <div class="upload-course-item-block course-overview-step1 radius-8">
                                            ...
                                            <div class="row mb-30">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" name="title" value="{{$course->title}}" class="form-control" placeholder="Eg: Figma Essential Training - 2021" required>
                                                    @if ($errors->has('title'))
                                            ...
                                            <div class="row mb-30">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" name="subtitle" value="{{$course->subtitle}}" class="form-control" placeholder="Eg: Figma Essential Training - 2021" required>
                                                    ...
                                                    <div id="add_repeater">
                                                        <div data-repeater-list="key_points" class="">
                                                            ...
                                                            @foreach($keyPoints as $keyPoint)
                                                                    <label for="name_{{ $keyPoint['id'] }}" class="text-lg-right text-black"> Name </label>
                                        ...
                                        <div class="stepper-action-btns">
                                            <a href="{{route('instructor.course')}}" class="theme-btn theme-button3">{{__('app.back')}}</a>
