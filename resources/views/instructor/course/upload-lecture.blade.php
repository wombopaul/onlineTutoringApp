...
@section('content')
                        ...
                        <div id="msform">
                            ...
                            <div class="upload-course-step-item upload-course-overview-step-item">
                                ...
                                <div class="upload-course-step-item upload-course-video-step-item">
                                    <form method="POST" action="{{route('store.lecture', [$course->uuid, $lesson->uuid])}}" class="row g-3 needs-validation" novalidate enctype="multipart/form-data" >
                                    @csrf
                                        ...
                                        <div class="upload-course-item-block course-overview-step1 radius-8">
                                            ...
                                            <div class="row mb-30">
                                                <div class="col-md-12">
                                                    <div class="d-flex">
                                                        ...
                                                        <div>
                                                            <label class="mr-15"><input type="radio" name="type" value="video" checked class="lecture-type"> Upload Video</label>
                                                            <label class="mr-15"><input type="radio" name="type" value="youtube" class="lecture-type" id="lectureTypeYoutube"> Youtube </label>
                                                            @if(env('VIMEO_STATUS') == 'active')
                                                            <label><input type="radio" name="type" value="vimeo" class="lecture-type">  Vimeo</label>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="video">
                                                <div class="upload-course-video-4-wrap upload-introduction-box-content-left d-flex align-items-center flex-column">
                                                    ...
                                                    <input type="file" name="video_file" accept="video/mp4" class="form-control" value="{{ old('video_file') }}" id="video_file" title="Upload lesson" required>
                                                </div>
                                            ...
                                            <div id="youtube" class="d-none">
                                                <input type="text" name="youtube_url_path" class="form-control youtube-url" value="{{ old('youtube_url_path') }}" id="youtube_url_path" placeholder="Type Your Youtube Video ID">
                                            </div>
                                            ...
                                            <div id="vimeo" class="d-none">
                                                <div class="upload-course-video-4-wrap upload-introduction-box-content-left d-flex align-items-center flex-column">
                                                    ...
                                                    <input type="file" name="vimeo_url_path" accept="video/mp4" class="form-control" value="{{ old('vimeo_url_path') }}" id="vimeo_url_path" title="Upload lesson" >
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        <div class="row mb-30">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" name="title" value="{{old('title')}}" class="form-control" placeholder="First steps" required>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-30">
                                                            <div class="col-md-12">
                                                                ...
                                                                <select name="lecture_type" class="form-select" required>
                                                                    ...
                                                                    <option value="1" @if(old('lecture_type') == 1) selected @endif >Show</option>
                                                                    <option value="2" @if(old('lecture_type') == 2) selected @endif >Lock</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="row mb-30 d-none" id="fileDuration">
                                                            <div class="col-md-12">
                                                                ...
                                                                <input type="text" name="youtube_file_duration" value="{{old('file_duration')}}" class="form-control customFileDuration" placeholder="First file duration" >
    ...
    <input type="text" value="{{ old('type') }}" class="oldTypeYoutube">
@endsection
