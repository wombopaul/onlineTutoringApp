            ...
            <div class="row instructor-dashboard-top-part instructor-only-dashboard-top-part">
                    ...
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <h6 class="para-color font-11 font-semi-bold text-uppercase">{{__('app.earning')}} <span
                                        class="color-gray font-13 text-capitalize font-normal">({{__('app.this_month')}})</span></h6>
                            </div>
                ...
                <div class="col-md-4 mb-30">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold text-uppercase">{{__('app.total_enroll')}} <span
                                    class="color-gray font-13 text-capitalize font-normal">({{__('app.this_month')}})</span></h6>
                            <h5>{{ @$total_enroll ?? 0 }}</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-30">
                    <div class="instructor-dashboard-top-part-item d-flex align-items-center radius-8">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h6 class="para-color font-11 font-semi-bold text-uppercase">{{__('app.best_selling_course')}}
                            </h6>
                ...
                <div class="col-lg-12 col-xl-6 mb-30">
                    <div class="recently-added-courses-box radius-8">
                        <div class="recently-added-courses-title d-flex justify-content-between align-items-center mb-4">
                            <h6 class="font-18">{{__('app.recently_added_courses')}}</h6>
                            <a href="{{route('instructor.course')}}" class="bg-transparent color-heading font-11 font-medium text-uppercase">View all</a>
                        </div>
                                ...
                                <div class="recently-added-course-item d-flex align-items-center">
                                    <div class="recently-added-course-item-left flex-shrink-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="font-15 text-capitalize">{{ Str::limit($recentCourse->title, 25) }}</h6>
                                                <p class="font-14">{{ @$recentCourse->orderItems->Count() }} {{__('app.enroll')}} </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-12 col-xl-6 mb-30">
                    <div class="recently-added-courses-box radius-8">
                        <div class="your-rank-title d-flex justify-content-between align-items-center mb-4">
                            <h6 class="font-18">Your Rank</h6>
                            <a href="{{ route('instructor.ranking-level') }}" class="bg-transparent color-hover font-11 font-medium text-uppercase">{{__('app.list_of_rank')}}</a>
                        </div>

                        <div class="ranking-items-wrap">
                            @php $rankLevel = true @endphp
                                    ...
                                    <div class="ranking-item d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center ranking-item-left">
                                            ...
                                            <div class="flex-grow-1 ranking-content-in-right">
                                                <h6 class="font-15 text-capitalize">{{ $level->name }}</h6>
                                            </div>
                                        </div>
                                        <div class="d-flex align-items-center ranking-item-right">
                                            <div class="flex-shrink-0">
                                                <p class="font-15 color-heading text-center">{{__('app.earning')}}</p>
                                            ...
                                            <div class="flex-shrink-0 ranking-content-in-right">
                                                <p class="font-15 color-heading text-center">{{__('app.student')}}</p>
                                                <p class="font-15 color-heading text-center">{{ $level->student }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    @php
                                        $level_serial_no = $level->serial_no + 1;
                                        $rankLevel = false;
                                        break;
                                    @endphp
                                @endif
                            ...
                            @php
                                if ($rankLevel){
                                    $next_level = \App\Models\RankingLevel::where('serial_no', 1)->first();
                                } else {
                            ...
                            <div class="ranking-item disable-ranking-item d-flex align-items-center justify-content-between">
                                <div class="d-flex align-items-center ranking-item-left">
                                    <div class="flex-shrink-0 user-img-wrap">
                                        <img src="{{ getImageFile(@$next_level->image_path) }}" alt="img" class="img-fluid">
                                    </div>
                                    <div class="flex-grow-1 ranking-content-in-right">
                                        <h6 class="font-15 text-capitalize">{{ @$next_level->name }}</h6>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center ranking-item-right">
                                    <div class="flex-shrink-0">
                                        ...
                                        <p class="font-15 color-heading text-center">
                                            @if(get_currency_placement() == 'after')
                                                {{ @$next_level->earning }} {{ get_currency_symbol() }}
                                            @else
                                                {{ get_currency_symbol() }} {{ @$next_level->earning }}
                                            @endif
                                        </p>
                                    </div>
                                    <div class="flex-shrink-0 ranking-content-in-right">
                                        <p class="font-15 color-heading text-center">{{__('app.student')}}</p>
                                        <p class="font-15 color-heading text-center">{{ @$next_level->student }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row upload-your-course-today mb-lg-0">
                <div class="col-lg-12 col-xl-6 mb-30">
                    <div class="upload-your-course-part radius-8">
                        <h6 class="font-18 text-white">{{__('app.upload_your_course_today')}}</h6>
                        <p class="font-14">Mornings of spring which I enjoy with my whole heart alone, and feel the charm of existence</p>
                        <a href="{{route('instructor.course.create')}}" class="upload-your-course-today-btn bg-hover text-white font-12 font-medium">{{__('app.upload_course')}}</a>
                    </div>
                </div>
                ...
                <div class="col-lg-6 mb-30">
                    <div class="instructor-dashboard-chart-box radius-8">
                        <div class="chart-title d-flex justify-content-between align-items-center">
                            <h6 class="font-18">{{__('app.sale_statistics')}}</h6>
                        </div>
                        <!-- Chart -->
