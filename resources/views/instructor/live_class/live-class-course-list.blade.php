...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-white pb-15"> Live Class </h3>

        <!-- Breadcrumb Start-->
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item font-14"><a href="{{route('instructor.dashboard')}}">{{__('app.dashboard')}}</a></li>
                <li class="breadcrumb-item font-14 active" aria-current="page">Live Class Course List</li>
            </ol>
        </nav>
    </div>
@endsection
                ...
                <div class="col-12">
                        ...
                        <div class="table-responsive table-responsive-xl">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">Upcoming Live Class</th>
                                    <th scope="col">Past Live Class</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="notice-board-action-btns">
                                                <a href="{{ route('live-class.create', [$course->uuid]) }}" class="theme-btn theme-button1 default-hover-btn">Create Live Class</a>
                                                <a href="{{ route('live-class.index', [$course->uuid]) }}" class="theme-btn theme-button1 green-theme-btn default-hover-btn">View
                                                    List</a>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    @else
                        ...
                        <div class="empty-data">
                            ...
                            <h5 class="my-3">Empty Course Live Class</h5>
                        </div>
