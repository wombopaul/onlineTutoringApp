...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-white pb-15"> Ranking Badge </h3>

        <!-- Breadcrumb Start-->
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item font-14"><a href="{{route('instructor.dashboard')}}">{{__('app.dashboard')}}</a></li>
                <li class="breadcrumb-item font-14 active" aria-current="page">Ranking Badge</li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <div class="instructor-profile-right-part">
        <div class="instructor-quiz-list-page instructor-ranking-badge-page">
            ...
            <div class="instructor-my-courses-title d-flex justify-content-between align-items-center">
                <h6>Ranking Badge List</h6>
                <a href="{{ route('instructor.dashboard') }}" class="theme-btn theme-button1 default-back-btn default-hover-btn m-0">Back</a>
            </div>
                        ...
                        <div class="ranking-item d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center ranking-item-right">
                                <div class="flex-shrink-0">
                                    <p class="font-15 color-heading text-center">Earning</p>
                                ...
                                <div class="flex-shrink-0 ranking-content-in-right">
                                    <p class="font-15 color-heading text-center">Student</p>
