            ...
            <div class="d-flex align-items-center courseId" data-course_id="{{ $course->id }}">
                <div class="flex-shrink-0">
                    <div class="user-img-wrap position-relative">
                        <img src="{{ asset('frontend/assets/img/courses-img/5.jpg') }}" alt="img" class="img-fluid">
                    </div>
                </div>
                <div class="flex-grow-1 ms-3 ">
                    <h6 class="font-16 font-medium text-capitalize">{{ Str::limit($course->title, 15) }}</h6>
