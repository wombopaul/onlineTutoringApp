...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-white pb-15">Discussion</h3>

        <!-- Breadcrumb Start-->
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item font-14"><a href="{{route('instructor.dashboard')}}">{{__('app.dashboard')}}</a></li>
                <li class="breadcrumb-item font-14 active" aria-current="page">Discussion</li>
            </ol>
        </nav>
    </div>
@endsection
                    ...
                    <div class="instructor-disscussion-page-leftside border-1 radius-4">
                        ...
                        <div class="message-user-top-part">
                            <div class="search-message-box input-group">
                                ...
                                <input type="text" class="form-control font-14 search_course_title" placeholder="Search Courses title" aria-label="Username" aria-describedby="basic-addon2">
                            </div>
                        </div>
