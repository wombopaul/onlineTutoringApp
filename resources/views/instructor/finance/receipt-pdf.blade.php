            ...
            <td style="padding: 16px;">
                ...
                <div style="display: block">
                    <div style="margin: 0 0 1.5rem 0; display: inline-block;">
                        <h4 style="margin: 0 0 1rem 0; color: #666666">Payment Receipt Invoice</h4>
                    ...
                    <div style="margin: 0 0 1.5rem 0; display: inline-block; float: right">
                        ...
                        <p style="margin: 4px 0; color: #666666; font-size: 14px;">Payment Date //</p>
                ...
                <table style="border-collapse: collapse;  width: 100%; font-size: 14px; margin-top: 25px; box-sizing: border-box">
                    ...
                    <tr style="background-color: #D5D7DC">
                        <th style="font-weight: normal; text-align: left; padding: 12px 16px">Request Date</th>
                        <th style="font-weight: normal; text-align: left; padding: 12px 16px">Payment Date</th>
