    ...
    <div class="page-banner-content text-center">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item font-14 active" aria-current="page">Edit Notice List</li>
            </ol>
        </nav>
    </div>
@endsection
      ...
      <div class="instructor-quiz-list-page instructor-notice-board-page">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <form action="{{ route('notice-board.update', [$course->uuid, $notice->uuid]) }}" method="post">
                @csrf
              <div class="row mb-30">
                <div class="col-md-12">
                    <label class="label-text-title color-heading font-medium font-16 mb-3">Notice Topic</label>
                    <input type="text" name="topic" class="form-control" placeholder="Enter your notice topic" value="{{ $notice->topic }}">
                    @if ($errors->has('topic'))
              ...
              <div class="row mb-30">
                <div class="col-md-12">
                    <label class="label-text-title color-heading font-medium font-16 mb-3">Notice Details</label>
                    <textarea class="form-control" name="details" cols="30" rows="10" placeholder="Enter your notice details">{{ $notice->details }}</textarea>
              ...
              <div>
                ...
                <button type="submit" class="theme-btn theme-button1 default-hover-btn">Update</button>
              </div>
            </form>
