...
@section('breadcrumb')
    <div class="page-banner-content text-center">
        <h3 class="page-banner-heading text-white pb-15"> {{__('app.add_notice')}} </h3>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center">
                ...
                <li class="breadcrumb-item font-14 active" aria-current="page">{{__('app.add_notice')}}</li>
            </ol>
        </nav>
    </div>
@endsection
            ...
            <form action="{{ route('notice-board.store', $course->uuid) }}" method="post">
              ...
              <div class="row mb-30">
                <div class="col-md-12">
                    ...
                    <input type="text" name="topic" class="form-control" placeholder="{{__('app.notice_topic')}}" required value="{{ old('topic') }}">
                    @if ($errors->has('topic'))
              ...
              <div class="row mb-30">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" name="details" cols="30" rows="10" placeholder="{{__('app.notice_details')}}" required>{{ old('details') }}</textarea>
              ...
              <div>
                <a href="{{ route('notice-board.index', $course->uuid) }}" class="theme-btn theme-button3 quiz-back-btn default-hover-btn">{{__('app.back')}}</a>
                <button type="submit" class="theme-btn theme-button1 default-hover-btn">{{__('app.create')}}</button>
              </div>
            </form>
