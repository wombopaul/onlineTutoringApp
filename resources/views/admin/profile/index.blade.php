                        ...
                        <div class="breadcrumb__content__right">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{__('app.update_profile')}}</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input__group mb-25">
                                                ...
                                                <input type="text" name="name" id="name" value="{{auth::user()->name}}" placeholder="{{__('app.name')}}" class="form-control">
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="col-md-6">
                                            <div class="input__group mb-25">
                                                <label for="phone_number">{{__('app.phone_number')}} <span class="text-danger">*</span></label>
                                                <input type="text" name="phone_number" id="phone_number" value="{{auth::user()->phone_number}}" placeholder="{{__('app.phone_number')}}" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input__group mb-25">
                                                <label for="address">{{__('app.email')}} <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="input__group mb-25">
                                                <label for="address">{{__('app.address')}} <span class="text-danger">*</span></label>
                                                <textarea name="address" id="address" class="form-control" placeholder="{{__('app.address')}}">{{auth::user()->address}}</textarea>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <p>Accepted Image Files: JPEG, JPG, PNG <br> Recommend Size: 300 x 300 (1MB)</p>
                                </div>
                            </div>
