                        ...
                        <div class="breadcrumb__content__right">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('role.index')}}">{{__('app.roles')}}</a></li>
                    ...
                    <div class="form-horizontal__item bg-style">
                        ...
                        <form action="{{route('role.update', [$role->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="custom-form-group mb-3 row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="name" id="name" value="{{$role->name}}" class="form-control flat-input" placeholder=" {{__('app.name')}} ">
                                    @if ($errors->has('name'))
                            ...
                            <div class="custom-form-group mb-3 row">
                                <label for="name" class="col-lg-3 text-lg-right text-black"> {{__('app.select_permission')}} </label>
                                <div class="col-lg-9">
                                    <div class="row text-black">
                                        @foreach($permissions as $permission)
                                            <div class="col-md-4 mb-2">
                                                <div class="form-check mb-0 d-flex align-items-center">
                                                    <input class="form-check-input" type="checkbox" name="permissions[]" id="permission{{$permission->id}}" value="{{$permission->id}}" @if(in_array($permission->id, $selected_permissions)) checked @endif >
