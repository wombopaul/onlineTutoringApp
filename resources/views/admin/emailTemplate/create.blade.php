                    ...
                    <div class="form-horizontal__item bg-style">
                        ...
                        <form action="{{route('email-template.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="custom-form-group mb-3 row">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="subject" id="subject" value="{{old('subject')}}" class="form-control flat-input" placeholder=" {{__('app.subject')}} ">
                            ...
                            <div class="custom-form-group mb-3 row">
                                ...
                                <div class="col-lg-9">
                                   <textarea name="body" id="body" class="form-control" placeholder="{{__('app.body')}}" rows="10">{{old('body')}}</textarea>
                                    @if ($errors->has('body'))
