                        ...
                        <div class="breadcrumb__content__right">
                            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('email-template.index')}}">{{__('app.email_template')}}</a></li>
                    ...
                    <div class="form-horizontal__item bg-style">
                        ...
                        <form action="{{route('email-template.send-email-to-user')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="custom-form-group mb-3 row">
                                <label for="email_template_id" class="col-lg-3 text-lg-right text-black"> {{__('app.name')}} </label>
                                <div class="col-lg-9">
                            ...
                            <div class="custom-form-group mb-3 row">
                                <label for="sender_type" class="col-lg-3 text-lg-right text-black"> {{__('app.type')}} </label>
                                <div class="col-lg-9">
                                    <select name="sender_type" class="form-control" id="sender_type">
                                        <option value="">-- Sender Type --</option>
                                            <option value="instructor" {{old('sender_type') == 'instructor' ? 'selected' : '' }}>Instructor</option>
                                            <option value="student" {{old('sender_type') == 'student' ? 'selected' : '' }} >Student</option>
                                            <option value="from_csv" {{old('sender_type') == 'from_csv' ? 'selected' : '' }} >Upload CSV</option>
                                    </select>
                                    ...
                                    <div class="mt-3 d-flex justify-content-between {{old('sender_type') == 'from_csv' ? '' : 'd-none' }} " id="csv_mail_list">
                                        ...
                                        <p class="font-14 color-heading text-center mt-2 color-gray"><a href="{{url('bulk_upload/send-mail.csv')}}" download=""> <i class="fa fa-download"></i> Sample File</a> </p>
                                    </div>
                            ...
                            <div class="mb-3">
                                <div class="col-md-12 text-right">
                                    <button type="submit" class="btn btn-blue mr-30">{{__('app.send')}}</button>
                                </div>
                            </div>
                        </form>
                    </div>
