                                ...
                                @foreach($comments as $comment)
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            ...
                                            <div class="text-capitalize mt-1">{{ @$comment->user->name }}</div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <select name="status" class="status label-inline font-weight-bolder mb-1 badge badge-info">
                                                ...
                                                <option value="0" @if($comment->status != 1) selected @endif>Disabled</option>
                                            </select>
                                        </td>
                ...
                if (result.value) {
                    $.ajax({
                        ...
                        success: function (data) {
                            console.log(data);
                            toastr.success('', 'Blog Comment status has been updated');
                        },
                        error: function () {
                            alert("Error!");
                        },
