                                                    ...
                                                    <form action="{{ route('support-ticket.admin.messageStore') }}" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12 mb-15">
                                                                <div class="">
                                                                    <h6 class="label-text-title color-heading font-medium font-16 mb-3">Upload Your File
                                                                    </h6>
                                                            ...
                                                            <div class="col-md-12 mb-20">
                                                                ...
                                                                @endif
                                                                <p class="font-14 placeholder-color mb-0">Valid file type : jpg, jpeg, gif, png and File size max : 10 MB</p>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="col-md-12 mb-30 create-tickets-btns">
                                                                <button type="submit" class="btn btn-blue theme-btn theme-button1 default-hover-btn">Submit</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
