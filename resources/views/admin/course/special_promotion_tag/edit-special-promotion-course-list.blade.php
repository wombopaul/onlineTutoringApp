...
@section('content')
                    ...
                    <div class="breadcrumb__content">
                        <div class="breadcrumb__content__left">
                            <div class="breadcrumb__title">
                                <h2>Update Special Promotion Tag Course</h2>
                            </div>
                        </div>
                        <div class="breadcrumb__content__right">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item "><a href="{{ route('special_promotional_tag.index') }}">Promotion Tag List</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Add/Remove Promotion Course</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
    ...
    <input type="hidden" class="addPromotionCourseRoute" value="{{ route('special_promotional_tag.addPromotionTagCourseList') }}">
    <input type="hidden" class="removePromotionCourseRoute" value="{{ route('special_promotional_tag.removePromotionTagCourseList') }}">
    <input type="hidden" class="special_id" value="{{ $special->id }}">
...
@push('script')
    ...
    <script src="{{ asset('admin/js/custom/special-promotion-tag.js') }}"></script>
@endpush
