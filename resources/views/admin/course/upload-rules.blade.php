                        ...
                        <div class="breadcrumb__content__right">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Upload Rules</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="customers__area bg-style mb-30">
                        ...
                        <form action="{{route('course-rules.store')}}" method="post" class="form-horizontal">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="title" class="col-lg-11"> Title <span class="text-danger">*</span></label>
                                <div class="col-lg-11">
                            ...
                            <div id="add_repeater" class="mb-3">
                                <div data-repeater-list="course_upload_rules" class="">
                                        ...
                                        @foreach($courseRules as $courseRule)
                                            <div data-repeater-item="" class="form-group row ">
                                                ...
                                                <div class="custom-form-group mb-3 col-md-11 col-lg-11 col-xl-11 col-xxl-11">
                                                    <label for="description_{{ @$courseRule['id'] }}" class="text-lg-right text-black"> Description </label>
                                    ...
                                    @else
                                        <div data-repeater-item="" class="form-group row">
                                            <div class="custom-form-group mb-3 col-md-11 col-lg-11 col-xl-11 col-xxl-11">
                                                <label for="description" class="text-lg-right text-black"> Description </label>
