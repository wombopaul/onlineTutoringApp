                        ...
                        <div class="breadcrumb__content__right">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{__('app.edit_tag')}}</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="form-vertical__item bg-style">
                        ...
                        <form action="{{route('tag.update', [$tag->uuid])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input__group mb-25">
                                ...
                                <div>
                                    <input type="text" name="name" id="name" value="{{$tag->name}}" class="form-control" placeholder=" {{__('app.name')}} ">
                                    @if ($errors->has('name'))
