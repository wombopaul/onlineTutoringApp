                    ...
                    <div class="form-vertical__item bg-style">
                        ...
                        <form action="{{route('category.update', [$category->uuid])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input__group mb-25">
                                ...
                                <div>
                                    <input type="text" name="name" id="name" value="{{$category->name}}" class="form-control flat-input" placeholder=" {{__('app.name')}} ">
                                    @if ($errors->has('name'))
                            ...
                            <div class="input__group mb-25">
                                ...
                                <div>
                                    <label class="text-black"> <input type="checkbox" name="is_feature" id="is_feature" value="yes" {{$category->is_feature == 'yes' ? 'checked' : '' }} > Yes </label>
                                </div>
                            </div>
