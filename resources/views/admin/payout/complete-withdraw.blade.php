                    ...
                    <div class="breadcrumb__content">
                        <div class="breadcrumb__content__left">
                            <div class="breadcrumb__title">
                                <h2>{{__('app.complete_withdrawal')}}</h2>
                            </div>
                        </div>
                        <div class="breadcrumb__content__right">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">{{__('app.complete_withdrawal')}}</li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                                        ...
                                        <tr class="removable-item">
                                            ...
                                            <td>
                                                ...
                                                @if($withdraw->payment_method == 'buy')
                                                    <div class="finance-table-inner-item my-2">
                                                        <span class="fw-bold mr-1">{{__('app.payment_method')}}</span>: Buy Course
                                                    </div>
                                                @endif
