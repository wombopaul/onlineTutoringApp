                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        ...
                                        <input type="text" name="coupon_code_name" value="{{old('coupon_code_name')}}" placeholder="Type coupon code name"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        ...
                                        <input type="date" name="start_date" value="{{old('start_date')}}" placeholder="Type coupon code name"
                                               class="form-control" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        ...
                                        <input type="date" name="end_date" value="{{old('end_date')}}" placeholder="Type coupon code name"
                                               class="form-control" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        ...
                                        <input type="number" min="0" name="minimum_amount" value="{{old('minimum_amount')}}" placeholder="Type minimum amount"
                                               class="form-control" required>
