...
@section('content')
                    ...
                    <div class="customers__area bg-style mb-30">
                        ...
                        <form action="{{route('coupon.update', $coupon->uuid)}}" method="post" class="form-horizontal">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        ...
                                        <input type="text" name="coupon_code_name" value="{{ $coupon->coupon_code_name }}" placeholder="Type coupon code name"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        ...
                                        <input type="date" name="start_date" value="{{ $coupon->start_date }}" placeholder="Type coupon code name"
                                               class="form-control" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        ...
                                        <input type="date" name="end_date" value="{{ $coupon->end_date }}" placeholder="Type coupon code name"
                                               class="form-control" required>
                            ...
                            <div class="row mb-3 d-none" id="instructor_id_div">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        <label for="instructor_ids">Instructor</label>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="input__group text-black">
                                        <label>Minimum Amount to Apply Coupon<span class="text-danger">*</span></label>
                                        <input type="number" min="0" name="minimum_amount" value="{{ $coupon->minimum_amount }}" placeholder="Type minimum amount"
                                               class="form-control" required>
    ...
    <input type="text" class="couponType" value="{{$coupon->coupon_type}}">
@endsection
