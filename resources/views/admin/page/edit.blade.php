                    ...
                    <div class="customers__area bg-style mb-30">
                        ...
                        <form action="{{route('page.update', $page->uuid)}}" method="post" class="form-horizontal">
                            ...
                            <div class="input__group mb-25">
                                ...
                                <input type="text" name="title" value="{{ $page->en_title }}" placeholder="{{__('app.title')}}" class="form-control slugable"  onkeyup="slugable()" required>
                                @if ($errors->has('title'))
                            ...
                            <div class="input__group mb-25 d-none" >
                                ...
                                <input type="text" name="slug" value="{{ $page->slug }}" placeholder="{{__('app.slug')}}" class="form-control slug" onkeyup="getMyself()" required>
                                @if ($errors->has('slug'))
                            ...
                            <div class="input__group mb-25">
                                ...
                                <textarea name="en_description" id="editor-text">{{  $page->en_description }}</textarea>
