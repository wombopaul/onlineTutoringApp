                    ...
                    <div class="email-inbox__area bg-style">
                        <div class="item-top mb-30"><h2>{{ @$title }}</h2></div>
                         <div class="customers__table">
                            ...
                            <thead>
                            <tr>
                                <th width="25%">{{__('app.page_name')}}</th>
                                <th>{{__('app.meta_content')}}</th>
                            ...
                            @foreach($metas as $meta)
                                <tr>
                                    ...
                                    <td>
                                        <div class="mb-2">
                                            <b>Meta Title: </b> {{ $meta->meta_title }}
                                        </div>
                                        <div class="mb-2">
                                            <b>Meta Description: </b> {{ $meta->meta_description }}
                                        </div>
                                        <div>
                                            <b>Meta Keywords: </b> {{ $meta->meta_keyword }}
                                        </div>
                                    </td>
                                    <td>
