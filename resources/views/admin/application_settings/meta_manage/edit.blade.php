                        ...
                        <div class="breadcrumb__content__right">
                            <nav aria-label="breadcrumb">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{route('settings.meta.index')}}">{{__('app.meta_management')}}</a></li>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="email-inbox__area form-horizontal__item bg-style bg-style admin-dashboard-meta-settings">
                        <div class="item-top mb-30"><h2>{{ @$title . ' - ' . $meta->page_name }}</h2></div>
                        <form action="{{route('settings.meta.update', [$meta->uuid])}}" method="post" enctype="multipart/form-data">
                            @csrf

                            <div class="input__group mb-25 row">
                                <label for="meta_title" class="col-lg-3 text-lg-right text-black mb-2"> {{__('app.meta_title')}} </label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="meta_description" class="col-lg-3 text-lg-right text-black mb-2"> {{__('app.meta_description')}} </label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="meta_keyword" class="col-lg-3 text-lg-right text-black mb-2"> {{__('app.meta_keywords')}} (Separate with commas)</label>
                                <div class="col-lg-9">
