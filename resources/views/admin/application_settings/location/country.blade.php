                        ...
                        <div class="customers__table">
                            <table id="customers-table" class="row-border data-table-filter table-style">
                                ...
                                <tr>
                                    ...
                                    <th>{{__('app.phone_code')}}</th>
                                    <th>{{__('app.continent')}}</th>
                                    <th>{{__('app.action')}}</th>
                                </tr>
                                </thead>
                                <tbody>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="country_name" id="country_name" placeholder="Type country name" value="{{ old('country_name') }}" required>
                            ...
                            <div class="col-6">
                                <div class="input__group mb-25">
                                    <label for="country_name">Short name</label>
                                    <input type="text" name="short_name" id="short_name" placeholder="Type short name" value="{{ old('short_name') }}" required>
                            ...
                            <div class="col-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="phonecode" id="phonecode" placeholder="Type phone code" value="{{ old('phonecode') }}" required>
                            ...
                            <div class="col-6">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="continent" id="continent" placeholder="Type continent" value="{{ old('continent') }}" required>
