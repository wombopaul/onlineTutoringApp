                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="country_name" id="country_name" placeholder="Type country name" value="{{ $country->country_name }}" required>
                                ...
                                <div class="col-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="short_name" id="short_name" placeholder="Type short name" value="{{ $country->short_name }}" required>
                                ...
                                <div class="col-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="phonecode" id="phonecode" placeholder="Type phone code" value="{{ $country->phonecode }}" required>
                                ...
                                <div class="col-6">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="continent" id="continent" placeholder="Type continent" value="{{ $country->continent }}" required>
