                    ...
                    <div class="email-inbox__area bg-style admin-about-us-instructor-support">
                        ...
                        <form action="{{route('settings.about.instructor-support.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class=" custom-form-group mb-3 row">
                                <label for="instructor_support_title" class="col-lg-3 text-lg-right text-black"> Instructor Support Title </label>
                                <div class="col-lg-9">
                                    <input type="text" name="instructor_support_title" id="instructor_support_title" value="{{ @$aboutUsGeneral->instructor_support_title }}"
                                           class="form-control" placeholder="Type team member title">
                            ...
                            <div class="col-lg-12 custom-form-group mb-3 row">
                                <label for="instructor_support_subtitle" class="col-lg-3 text-lg-right text-black"> Instructor Support Subtitle </label>
                                <div class="col-lg-9">
                            ...
                            <div id="add_repeater" class="mb-3">
                                <div data-repeater-list="instructor_supports" class="">
                                        ...
                                        @foreach($instructorSupports as $instructorSupport)
                                            <div data-repeater-item="" class="form-group row ">
                                                ...
                                                <div class="custom-form-group mb-3 col-lg-2">
                                                    ...
                                                    <p><span class="text-black">Accepted Files:</span> PNG <br> <span class="text-black">Accepted Size:</span> 148 x 148</p>
                                                </div>

                                                <div class="custom-form-group mb-3 col-lg-5">
                                                    <label for="title_{{ $instructorSupport->id }}" class="text-lg-right text-black"> Title </label>
                                                ...
                                                <div class="custom-form-group mb-3 col-lg-5">
                                                    <label for="subtitle_{{ $instructorSupport->id }}" class="text-lg-right text-black"> Subtitle </label>
                                                ...
                                                <div class="custom-form-group mb-3 col-lg-3">
                                                    <label for="button_name_{{ $instructorSupport->id }}" class="text-lg-right text-black"> Button Name </label>
                                                    <input type="text" name="button_name" id="button_name_{{ $instructorSupport->id }}"
                                                           value="{{ $instructorSupport->button_name }}" class="form-control" placeholder="Type button name">
                                                </div>
                                                <div class="custom-form-group mb-3 col-lg-9">
                                                    <label for="button_link_{{ $instructorSupport->id }}" class="text-lg-right text-black"> Button Link </label>
                                                    <input type="text" name="button_link" id="button_link_{{ $instructorSupport->id }}"
                                                           value="{{ $instructorSupport->button_link }}" class="form-control" placeholder="Type button link">
                                                </div>

                                                <div class="col-lg-1 mb-3 removeClass">
                                                    <label class="text-lg-right text-black opacity-0">Remove</label>
                                    ...
                                    @else
                                        <div data-repeater-item="" class="form-group row ">
                                            <div class="custom-form-group mb-3 col-lg-2">
                                                <label for="image" class=" text-lg-right text-black"> Logo </label>
                                                <div class="upload-img-box">
                                                    <img src="">
                                            ...
                                            <div class="custom-form-group mb-3 col-lg-5">
                                                <label for="title" class="text-lg-right text-black"> Title </label>
                                                <input type="text" name="title" id="title" value="" class="form-control" placeholder="Type name">

                                            </div>
                                            <div class="custom-form-group mb-3 col-lg-5">
                                                <label for="subtitle" class="text-lg-right text-black"> Subtitle </label>
                                                <textarea name="subtitle" class="form-control" rows="5" id="subtitle" required></textarea>
                                            </div>
                                            <div class="custom-form-group mb-3 col-lg-3">
                                                <label for="button_name" class="text-lg-right text-black"> Button Name </label>
                                                <input type="text" name="button_name" id="button_name" value="" class="form-control" placeholder="Type button name">
                                            </div>
                                            <div class="custom-form-group mb-3 col-lg-9">
                                                <label for="button_link" class="text-lg-right text-black"> Button Link </label>
                                                <input type="text" name="button_link" id="button_link" value="" class="form-control" placeholder="Type button link">
                                            </div>
