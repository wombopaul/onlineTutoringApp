                    ...
                    <div class="email-inbox__area bg-style admin-team-member-section">
                        ...
                        <form action="{{route('settings.about.team-member.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="custom-form-group mb-3 row">
                                <label class="col-lg-3 text-lg-right text-black">Logo </label>
                                <div class="col-lg-3">
                                    ...
                                    <p><span class="text-black">Accepted Files: </span> PNG <br> <span class="text-black">Accepted Size:</span> 70 x 70 (1MB)</p>
                                </div>
                            </div>

                            <div class="row custom-form-group mb-3">
                                <label for="team_member_title" class="col-lg-3 text-lg-right text-black">Title </label>
                                <div class="col-lg-9">
                            ...
                            <div class="custom-form-group mb-3 row">
                                <label for="team_member_subtitle" class="col-lg-3 text-lg-right text-black">Subtitle </label>
                                <div class="col-lg-9">
                                        ...
                                        @foreach($teamMembers as $teamMember)
                                            <div data-repeater-item="" class="form-group row ">
                                                ...
                                                <div class="custom-form-group mb-3 col-md-12 col-lg-3 col-xl-3 col-xxl-2">
                                                    <label for="image_{{ $teamMember->id }}" class=" text-lg-right text-black"> Member Image </label>
                                                    <div class="upload-img-box">
                                                        @if($teamMember->image)
                                                    ...
                                                    <p><span class="text-black">Accepted Files: </span>JPG, JPEG, PNG <br> <span class="text-black">Accepted Size:</span> 300 x 343 (1MB)</p>
                                                </div>

                                                <div class="custom-form-group mb-3 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
                                                    <label for="name_{{ $teamMember->id }}" class="text-lg-right text-black"> Name </label>
                                                    <div class="">
                                                        <input type="text" name="name" id="name_{{ $teamMember->id }}" value="{{ $teamMember['name'] }}"
                                                               class="form-control" placeholder="Type name" required>
                                                    </div>
                                                </div>
                                                <div class="custom-form-group mb-3 col-md-12 col-lg-4 col-xl-4 col-xxl-5">
                                                    <label for="designation_{{ $teamMember->id }}" class="text-lg-right text-black"> Designation </label>
                                    ...
                                    @else
                                        <div data-repeater-item="" class="form-group row ">
                                            <div class="custom-form-group mb-3 col-lg-3">
                                                <label for="image" class=" text-lg-right text-black"> Member Image </label>
                                                <div class="upload-img-box">
                                                    <img src="" alt="">
                                            ...
                                            <div class="custom-form-group mb-3 col-lg-4">
                                                <label for="designation" class="text-lg-right text-black"> Designation </label>
