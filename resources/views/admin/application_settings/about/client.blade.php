                            ...
                            <div id="add_repeater" class="mb-3">
                                <div data-repeater-list="client_details" class="">
                                        ...
                                        @foreach($clients as $client)
                                            <div data-repeater-item="" class="form-group row">
                                                ...
                                                <div class="custom-form-group mb-3 col-md-12 col-lg-3 col-xl-3 col-xxl-2">
                                                    <label for="image_{{ @$client['id'] }}" class=" text-lg-right text-black"> Client Logo </label>
                                                    ...
                                                    <p><span class="text-black">Accepted Files:</span> PNG <br> <span class="text-black">Accepted Size:</span> 120 x 41</p>
                                                </div>
                                                <div class="custom-form-group mb-3 col-md-12 col-lg-8 col-xl-8 col-xxl-9">
                                                    <label for="name_{{ @$client['id'] }}" class="text-lg-right text-black"> Client Name </label>
                                                    <div class="">
                                                        <input type="text" name="name" id="name_{{ @$client['id'] }}" value="{{ $client->name }}" class="form-control" placeholder="Type name" required>
                                                    </div>
                                                </div>
                                    ...
                                    @else
                                        <div data-repeater-item="" class="form-group row">
                                            <div class="custom-form-group mb-3 col-md-12 col-lg-3 col-xl-3 col-xxl-2">
                                                <label for="image" class=" text-lg-right text-black"> Client Logo </label>
                                                <div class="upload-img-box">
                                                    <img src="">
                                            ...
                                            <div class="custom-form-group mb-3 col-md-12 col-lg-8 col-xl-8 col-xxl-9">
                                                <label for="name" class="text-lg-right text-black"> Client Name</label>
                                                <div class="">
