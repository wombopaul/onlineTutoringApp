                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.about.gallery-area.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="custom-form-group mb-3 row">
                                <label for="gallery_area_title" class="col-lg-3 text-lg-right text-black"> Gallery Area Title </label>
                                <div class="col-lg-9">
                            ...
                            <div class="custom-form-group mb-3 row">
                                <label for="gallery_area_subtitle" class="col-lg-3 text-lg-right text-black"> Gallery Area Subtitle </label>
                                <div class="col-lg-9">
                            ...
                            <div class="custom-form-group mb-3 row">
                                <label class="col-lg-3">Gallery First Image</label>
                                <div class="col-lg-5">
                                    ...
                                    @endif
                                    <p><span class="text-black">Accepted Files:</span> JPG <br> <span class="text-black">Recommend Size:</span> 536 x 644 (1MB)</p>
                                </div>
                            </div>

                            <div class="custom-form-group mb-3 row">
                                <label class="col-lg-3">Gallery Second Image</label>
                                <div class="col-lg-5">
                                    <div class="upload-img-box">
                                    ...
                                    @endif
                                    <p><span class="text-black">Accepted Files:</span> JPG <br> <span class="text-black">Recommend Size:</span> 536 x 309 (1MB)</p>
                                </div>
                            </div>

                            <div class="custom-form-group mb-3 row">
                                <label class="col-lg-3">Gallery Third Image</label>
                                <div class="col-lg-5">
                                    <div class="upload-img-box">
