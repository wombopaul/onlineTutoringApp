                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="currency_code" id="currency_code" placeholder="Type currency code" value="{{ $currency->currency_code }}" required>
                                ...
                                <div class="col-12">
                                    <div class="input__group mb-25">
                                        ...
                                        <input type="text" name="symbol" id="symbol" placeholder="Type symbol" value="{{ $currency->symbol }}" required>
