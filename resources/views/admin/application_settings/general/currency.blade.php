                    ...
                    <div class="customers__area bg-style mb-30">
                        ...
                        <div class="customers__table">
                                <table id="customers-table" class="row-border data-table-filter table-style">
                                    ...
                                    <tr>
                                        <th>{{__('app.sl')}}</th>
                                        <th>{{__('app.currency_code')}}</th>
                                        <th>{{__('app.symbol')}}</th>
                                        <th>{{__('app.currency_placement')}}</th>
                                        <th>{{__('app.action')}}</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input__group mb-25">
                                    <label for="currency_code">Currency ISO Code</label>
                                    <input type="text" name="currency_code" id="currency_code" placeholder="Type currency code" value="{{ old('currency_code') }}" required>
                            ...
                            <div class="col-12">
                                <div class="input__group mb-25">
                                    ...
                                    <input type="text" name="symbol" id="symbol" placeholder="Type symbol" value="{{ old('symbol') }}" required>
                            ...
                            <div class="col-12">
                                <div class="input__group mb-25">
                                    <label for="currency_placement">Currency Placement</label>
