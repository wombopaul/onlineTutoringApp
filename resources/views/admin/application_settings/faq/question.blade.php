            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8">
                    <div class="email-inbox__area  bg-style">
                        ...
                        <form action="{{route('settings.faq.question.update')}}" method="post">
                            @csrf
                            <div id="add_repeater" class="mb-3">
                                <div data-repeater-list="question_answers" class="">
                                        ...
                                        @foreach($faqQuestions as $faqQuestion)
                                            <div data-repeater-item="" class="form-group row">
                                                ...
                                                <div class="custom-form-group mb-3 col-lg-5">
                                                    <label for="question_{{ @$faqQuestion['id'] }}" class="text-lg-right text-black"> Question </label>
                                                    <div class="">
                                                        <input type="text" name="question" id="question_{{ @$faqQuestion['id'] }}" value="{{ $faqQuestion->question }}"
                                                               class="form-control" placeholder="Type question" required>
                                                    </div>
                                                </div>
                                                <div class="custom-form-group mb-3 col-lg-6">
                                                    <label for="answer_{{ @$faqQuestion['id'] }}" class="text-lg-right text-black"> Answer </label>
                                                    <div class="">
                                                        <textarea name="answer" id="answer_{{ @$faqQuestion['id'] }}" rows="5"
                                                                  class="form-control" required>{{ $faqQuestion->answer }}</textarea>
                                                    </div>
                                                </div>
                                    ...
                                    @else
                                        <div data-repeater-item="" class="form-group row ">
                                            <div class="custom-form-group mb-3 col-lg-5">
                                                <label for="question" class="text-lg-right text-black">Question</label>
                                                <input type="text" name="question" id="question" value="" class="form-control" placeholder="Type question" required>
                                            </div>
                                            <div class="custom-form-group mb-3 col-lg-6">
                                                <label for="answer" class="text-lg-right text-black">Answer</label>
