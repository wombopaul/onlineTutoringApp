                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3">Main Image</label>
                                <div class="col-lg-3">
                                    ...
                                    @endif
                                    <p><span class="text-black">Accepted Files:</span> JPG,PNG, JPEG <br> <span class="text-black">Accepted Size:</span> 650 x 650</p>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3" for="faq_title">Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="faq_title" value="{{get_option('faq_title')}}" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3" for="faq_subtitle">Subtitle <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <textarea name="faq_subtitle" id="faq_subtitle" class="form-control" required>{{get_option('faq_subtitle')}}</textarea>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3" for="faq_image_title">Image Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
