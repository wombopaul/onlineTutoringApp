                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.banner-section.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="banner_mini_words_title" class="col-lg-3"> Mini Title</label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="banner_first_line_title" class="col-lg-3"> First Line Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="banner_second_line_title" class="col-lg-3"> Second Line Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="banner_second_line_changeable_words" class="col-lg-3"> Second Line Changeable Word Title</label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="banner_third_line_title" class="col-lg-3"> Third Line Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="banner_subtitle" class="col-lg-3"> Subtitle <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="banner_subtitle" id="banner_subtitle" value="{{ @$home->banner_subtitle }}" class="form-control" required>
                                </div>
                            </div>
                            <div class="input__group mb-25 row">
                                <label for="banner_first_button_name" class="col-lg-3">First Button Name </label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="banner_first_button_link" class="col-lg-3">First Button Link </label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="banner_second_button_name" class="col-lg-3">Second Button Name</label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label for="banner_second_button_link" class="col-lg-3">Second Button Link </label>
                                <div class="col-lg-9">
                            ...
                            <div class="input__group mb-25 row">
                                <label class="col-lg-3">Banner Image</label>
                                <div class="col-lg-5">
