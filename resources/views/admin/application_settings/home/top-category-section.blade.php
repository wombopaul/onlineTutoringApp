                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="top_category_logo" class="col-lg-3">Logo</label>
                                <div class="col-lg-2">
                                    ...
                                    @endif
                                    <p><span class="text-black">Accepted Files:</span> PNG <br> <span class="text-black">Accepted Size:</span> 60 x 60</p>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label for="top_category_title" class="col-lg-3">Top Category Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="top_category_subtitle" class="col-lg-3">Top Category Subtitle <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
