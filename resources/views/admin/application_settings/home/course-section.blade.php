                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="course_logo" class="col-lg-3">Logo</label>
                                <div class="col-lg-2">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="course_title" class="col-lg-3">Course Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="course_title" id="course_title" value="{{get_option('course_title')}}" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label for="course_subtitle" class="col-lg-3">Course Subtitle <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
