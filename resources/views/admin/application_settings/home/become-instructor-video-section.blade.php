                    ...
                    <div class="email-inbox__area bg-style admin-become-instructor-video">
                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="become_instructor_video_logo" class="col-lg-3">Video</label>
                                <div class="col-lg-4 col-xl-4 col-xxl-3">
                                    ...
                                    <div class="video-area-left position-relative d-flex align-items-center justify-content-center mt-2">
                                        ...
                                        <a class="play-btn position-absolute venobox vbox-item" data-autoplay="true" data-maxwidth="800px"
                                           data-vbtype="video" href="{{ asset(get_option('become_instructor_video')) }}">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="become_instructor_video_preview_image" class="col-lg-3">Video Preview Image</label>
                                <div class="col-lg-4 col-xl-4 col-xxl-3">
                                    ...
                                    @endif
                                    <p><span class="text-black">Accepted Files:</span> PNG <br> <span class="text-black">Accepted Size:</span> 835 x 630</p>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label for="become_instructor_video_logo" class="col-lg-3">Logo</label>
                                <div class="col-lg-4 col-xl-4 col-xxl-3">
                                    <div class="upload-img-box">
                                    ...
                                    @endif
                                    <p><span class="text-black">Accepted Files:</span> PNG <br> <span class="text-black">Accepted Size:</span> 70 x 70</p>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label for="become_instructor_video_title" class="col-lg-3">Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="become_instructor_video_subtitle" class="col-lg-3">Subtitle <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
