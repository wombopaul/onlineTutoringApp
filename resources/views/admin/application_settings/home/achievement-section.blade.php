                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="custom-form-group mb-3 col-md-12 col-lg-3 col-xl-3 col-xxl-2">
                                    <label for="achievement_first_logo" class=" text-lg-right text-black"> First Logo </label>
                                    ...
                                    @endif
                                    <p><span class="text-black">Accepted Files:</span> PNG <br> <span class="text-black">Accepted Size:</span> 58 x 58</p>
                                </div>
                                <div class="custom-form-group mb-3 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
                                    <label for="achievement_first_title" class="text-lg-right text-black"> First Title</label>
                                ...
                                <div class="custom-form-group mb-3 col-md-12 col-lg-5 col-xl-5 col-xxl-6">
                                    <label for="achievement_first_subtitle" class="text-lg-right text-black"> First Subtitle</label>
                            ...
                            <div class="row">
                                <div class="custom-form-group mb-3 col-md-12 col-lg-3 col-xl-3 col-xxl-2">
                                    <label for="achievement_second_logo" class=" text-lg-right text-black"> Second Logo </label>
                                    <div class="upload-img-box">
                                ...
                                <div class="custom-form-group mb-3 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
                                    <label for="achievement_second_title" class="text-lg-right text-black"> Second Title</label>
                                ...
                                <div class="custom-form-group mb-3 col-md-12 col-lg-5 col-xl-5 col-xxl-6">
                                    <label for="achievement_second_subtitle" class="text-lg-right text-black"> Second Subtitle</label>
                            ...
                            <div class="row">
                                <div class="custom-form-group mb-3 col-md-12 col-lg-3 col-xl-3 col-xxl-2">
                                    <label for="achievement_third_logo" class=" text-lg-right text-black"> Third Logo </label>
                                    <div class="upload-img-box">
                                ...
                                <div class="custom-form-group mb-3 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
                                    <label for="achievement_third_title" class="text-lg-right text-black"> Third Title</label>
                                ...
                                <div class="custom-form-group mb-3 col-md-12 col-lg-5 col-xl-5 col-xxl-6">
                                    <label for="achievement_thirdsubtitle" class="text-lg-right text-black"> Third Subtitle</label>
                            ...
                            <div class="row">
                                <div class="custom-form-group mb-3 col-md-12 col-lg-3 col-xl-3 col-xxl-2">
                                    <label for="achievement_four_logo" class=" text-lg-right text-black"> Four Logo </label>
                                    <div class="upload-img-box">
                                ...
                                <div class="custom-form-group mb-3 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
                                    <label for="achievement_four_title" class="text-lg-right text-black"> Four Title</label>
                                ...
                                <div class="custom-form-group mb-3 col-md-12 col-lg-5 col-xl-5 col-xxl-6">
                                    <label for="achievement_four_subtitle" class="text-lg-right text-black"> Four Subtitle</label>
