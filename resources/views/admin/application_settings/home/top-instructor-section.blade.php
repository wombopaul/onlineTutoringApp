                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="top_instructor_logo" class="col-lg-3">Logo</label>
                                <div class="col-lg-2">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="top_instructor_title" class="col-lg-3">Top Instructor Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label for="top_instructor_subtitle" class="col-lg-3">Top Instructor Subtitle <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
