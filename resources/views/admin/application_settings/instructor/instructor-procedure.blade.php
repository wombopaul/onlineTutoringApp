                            ...
                            <div id="add_repeater" class="mb-3">
                                <div data-repeater-list="instructor_procedures" class="">
                                        ...
                                        @foreach($instructorProcedures as $procedure)
                                            <div data-repeater-item="" class="form-group row ">
                                                ...
                                                <div class="custom-form-group mb-3 col-md-12 col-lg-3 col-xl-3 col-xxl-2">
                                                    <label for="image_{{ @$procedure['id'] }}" class=" text-lg-right text-black"> Image </label>
                                                ...
                                                <div class="custom-form-group mb-3 col-md-12 col-lg-4 col-xl-4 col-xxl-4">
                                                    <label for="title_{{ @$procedure['id'] }}" class="text-lg-right text-black"> Title </label>
                                                    <div class="">
                                                        <input type="text" name="title" id="title_{{ @$procedure['id'] }}" value="{{ $procedure->title }}" class="form-control" placeholder="Type title" required>
                                                    </div>
                                                </div>
                                                <div class="custom-form-group mb-3 col-md-12 col-lg-4 col-xl-4 col-xxl-5">
                                                    <label for="subtitle_{{ @$procedure['id'] }}" class="text-lg-right text-black"> Subtitle </label>
                                    ...
                                    @else
                                        <div data-repeater-item="" class="form-group row">
                                            <div class="custom-form-group mb-3 col-md-12 col-lg-3 col-xl-3 col-xxl-2">
                                                <label for="image" class=" text-lg-right text-black"> Image </label>
