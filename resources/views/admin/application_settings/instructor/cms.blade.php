                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3" for="app_instructor_footer_title">Instructor Footer Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3" for="app_instructor_footer_subtitle">Instructor Footer Subtitle <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
