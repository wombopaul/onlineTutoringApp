...
@section('content')
                    ...
                    <div class="email-inbox__area bg-style">
                        <div class="item-top mb-30 d-flex justify-content-between">
                            ...
                            <button class="btn btn-success btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#add-todo-modal">
                                <i class="fa fa-plus"></i> Add Related Service
                            </button>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action__buttons">
                                            <a class=" btn-action mr-1 edit" data-item="{{ $service }}" data-toggle="tooltip" title="Edit">
                                                <img src="{{asset('admin/images/icons/edit-2.svg')}}" alt="edit">
                                            </a>
                                            <button class="ms-2">
                                                <span data-formid="delete_row_form_{{$service->uuid}}" class="deleteItem">
                                                    <img src="{{asset('admin/images/icons/trash-2.svg')}}" alt="trash">
                                                </span>
                                            </button>

                                            <form action="{{ route('settings.support-ticket.services.delete', $service->uuid) }}" method="post" id="delete_row_form_{{ $service->uuid }}">
                                                {{ method_field('DELETE') }}
    ...
    <div class="modal fade edit_modal" id="add-todo-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Related Service</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
