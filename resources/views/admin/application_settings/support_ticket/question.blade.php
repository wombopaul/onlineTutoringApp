                                        ...
                                        @foreach($supportTickets as $question)
                                            <div data-repeater-item="" class="form-group row ">
                                                ...
                                                <div class="custom-form-group mb-3 col-lg-5">
                                                    <label for="question_{{ @$question['id'] }}" class="text-lg-right text-black"> Question </label>
                                                    <div class="">
                                                ...
                                                <div class="custom-form-group mb-3 col-lg-6">
                                                    <label for="answer_{{ @$question['id'] }}" class="text-lg-right text-black"> Answer </label>
                                                    <div class="">
