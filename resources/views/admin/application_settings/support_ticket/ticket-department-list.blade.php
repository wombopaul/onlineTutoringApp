                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action__buttons">
                                            <a class=" btn-action mr-1 edit" data-item="{{ $department }}" data-toggle="tooltip" title="Edit">
                                                <img src="{{asset('admin/images/icons/edit-2.svg')}}" alt="edit">
                                            </a>
                                            <button class="ms-2">
                                                <span data-formid="delete_row_form_{{$department->uuid}}" class="deleteItem">
                                                    <img src="{{asset('admin/images/icons/trash-2.svg')}}" alt="trash">
                                                </span>
                                            </button>

                                            <form action="{{ route('settings.support-ticket.department.delete', $department->uuid) }}" method="post" id="delete_row_form_{{ $department->uuid }}">
                                                {{ method_field('DELETE') }}
    ...
    <div class="modal fade" id="add-todo-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('settings.support-ticket.department.store') }}" method="post">
    ...
    <div class="modal fade edit_modal" id="add-todo-modal" aria-hidden="true" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('settings.support-ticket.department.store') }}" id="updateEditModal" method="post">
                    @csrf
