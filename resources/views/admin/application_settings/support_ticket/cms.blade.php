                    ...
                    <div class="email-inbox__area bg-style">
                        ...
                        <form action="{{route('settings.general_setting.cms.update')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3" for="support_faq_title">Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="support_faq_title" value="{{get_option('support_faq_title')}}" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3" for="support_faq_subtitle">Subtitle <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="support_faq_subtitle" value="{{get_option('support_faq_subtitle')}}" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3" for="ticket_title">Ticket Title <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
                                    <input type="text" name="ticket_title" value="{{get_option('ticket_title')}}" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group text-black row mb-3">
                                <label class="col-lg-3" for="ticket_subtitle">Ticket Subtitle <span class="text-danger">*</span></label>
                                <div class="col-lg-9">
