        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="status__box status__box__v3 bg-style">
                        ...
                        <div class="status__box__text">
                            ...
                            <h3>Total Platform Charge (Current Month)</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    ...
                    <div class="status__box status__box__v3 bg-style">
                        ...
                        <div class="status__box__text">
                            <h2 class="color-red">
                                ...
                                @endif</h2>
                            <h3>Total Sell Commission (Current Month)</h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                ...
                <div class="col-md-8">
                    <div class="revenue__chart-v2__area bg-style">
                        ...
                        <div class="total-profit">
                            <h2>
                                Total Enrollment <span>{{ $total_enrolments }}</span>
                            </h2>
                        </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="top-products__area bg-style">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <h2>Top Courses</h2>
                            <a href="{{ route('admin.course.index') }}"><button class="btn bg-primary">View All</button></a>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="top-products__area bg-style">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            <h2>Requested Withdrawal</h2>
                            <a href="{{ route('payout.new-withdraw') }}"><button class="btn bg-primary">View All</button></a>
                        </div>
                        <div class="top-products__table">
                            <table class="table-style">
                                <thead>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="2">No Requested Found</td>
                                    </tr>
                                @endforelse
                                </tbody>
                            </table>
