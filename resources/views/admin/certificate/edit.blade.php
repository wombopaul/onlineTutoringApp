                                                            ...
                                                            <div class="certificate-inner-box">
                                                                <div class="row">
                                                                    <div class="col-md-12 mb-15">
                                                                        ...
                                                                        <input type="text" name="title" value="{{$certificate->title}}" class="form-control" placeholder="Certificate Title">
                                                                        @if ($errors->has('title'))
                                                        ...
                                                        <div class="accordion-body">
                                                            <div class="certificate-inner-box">
                                                                <div class="row">
                                                                    <div class="col-md-12 mb-15">
                                                                        <div class="label-text-title color-heading font-16 mb-1">Title</div>
                                                                        <input type="text" name="role_1_title" value="{{$certificate->role_1_title}}" class="form-control" placeholder="Administrator">
