                ...
                <div class="col-md-7">
                    <div class="sign-up-right-content bg-white">
                        <form action="{{ route('forget-password.email') }}" method="post">
                            ...
                            <h5 class="mb-1">{{ get_option('forgot_title') }}</h5>
                            <div class="forgot-pass-text mb-25 mt-3">
                                <p class="mb-2">{{ get_option('forgot_subtitle') }}</p>
                            </div>
                            ...
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <button type="submit" class="theme-btn theme-button1 theme-button3 font-15 fw-bold w-100">{{ get_option('forgot_btn_name') }}</button>
                                </div>
                            </div>
                            <div class="row mb-30">
