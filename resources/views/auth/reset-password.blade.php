                ...
                <div class="col-md-7">
                    <div class="sign-up-right-content bg-white">
                        <form action="{{ route('reset-password') }}" method="post">
                            ...
                            <p>*Verification code sent your email. Please check.</p> <br>
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <label class="label-text-title color-heading font-medium font-16 mb-3">Verification Code</label>
                                    <div class="form-group mb-0 position-relative">
                                        <input class="form-control " name="verification_code" placeholder="Type your verification code" type="number" required>
                                    </div>
                            ...
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <label class="label-text-title color-heading font-medium font-16 mb-3">New Password</label>
                                    <div class="form-group mb-0 position-relative">
                            ...
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <label class="label-text-title color-heading font-medium font-16 mb-3">Confirm Password</label>
                                    <div class="form-group mb-0 position-relative">
                            ...
                            <div class="row mb-30">
                                <div class="col-md-12">
                                    <button type="submit" class="theme-btn theme-button1 theme-button3 font-15 fw-bold w-100">Change Password</button>
                                </div>
                            </div>
                            <div class="row mb-30">
                                <div class="col-md-12"><a href="{{ route('login') }}" class="color-hover text-decoration-underline font-medium">    Back to Login?</a></div>
                            </div>
                        </form>
                    </div>
                </div>
