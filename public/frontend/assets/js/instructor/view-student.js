(function ($) {
    ...
    $('.viewStudent').on('click', function(e){
        ...
        modal.find('.phone').text($(this).data('item').order.user.phone_number);
        modal.find('.user_name').text($(this).data('item').order.user.name);
        modal.find('.email').text($(this).data('item').order.user.email);
